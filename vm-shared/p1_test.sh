...
curl -s -XPOST 'localhost:9200/task2a/_refresh?pretty' > /dev/null
curl -s -XPOST 'localhost:9200/task2b/_refresh?pretty' > /dev/null
curl -s -XPOST 'localhost:9200/task2c/_refresh?pretty' > /dev/null
